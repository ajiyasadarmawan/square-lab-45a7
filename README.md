...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/square-lab-45a7#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/square-lab-45a7
```

A live public deployment of this template is available at [https://square-lab-45a7.templates.workers.dev](https://square-lab-45a7.templates.workers.dev)
